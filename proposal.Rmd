...
Efforts such as Rcpp and reticulate have established that it can bve an advantage 
...
from R, and this is what the `ergo` project is about. We want R packages to 
